public class Main
{
    ...
    {
        // intOperandA, intOperandB, intSum, intProduct, intDifference, intQuotient, intModulo (Remainder)
        int intOperandA = 4;
        int intOperandB = 7;
        int intSum = 0;
        int intProduct = 0;
        ...
        double doubleOperandB = 3.40;
        double doubleSum = 0;
        double doubleProduct = 0;
        double doubleDifference = 0;

        doubleSum = doubleOperandA + doubleOperandB;
        System.out.println("The Sum of " + doubleOperandA + " and " + doubleOperandB + " is " + intSum);
